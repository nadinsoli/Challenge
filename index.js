...
notifications.forEach(notification => {
  ...
  const notificationHTML = `
    <div class="notification ${notification.unread ? 'unread' : 'read'}">
      <a href="#" class="openModalButton${notification.id} openModal" data-bs-toggle="modal" data-bs-target="#userProfileModal${notification.id}">
